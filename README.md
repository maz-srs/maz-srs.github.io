...
- Minimize button hides the window and adds it to the taskbar as an icon (click to restore)
- Maximize button expands the window to fill the screen
- Windows stack correctly on top of each other based on which one was last clicked
...
- Custom pixel font throughout the interface [Minecraftia.font](https://www.dafont.com/minecraftia.font)
